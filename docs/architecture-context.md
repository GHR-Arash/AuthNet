...
- Same-origin SPA account, authenticator-app MFA, external-login orchestration, and invitation acceptance workflows through JSON account endpoints and the existing Identity application cookie.
